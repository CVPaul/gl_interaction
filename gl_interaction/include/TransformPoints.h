...
/**
==================================================================================================
 * class Transform packagae the common operation for 3d points, this class is desgined to deal
 * with the problem that we can not conviniently get the tranfomed points's coordinates in opengl at the beginning
...
public:
	...
	*/
	void roteByAxis(float angle, float axis_x, float axis_y, float axis_z);
	...
	* return[void] and no output but this will change the trans_mat
	*/
	void roteByMatrix(float rot_mat[9]);
	...
	*/
	void TranformInOnce(const GLMmodel* org_model, GLMmodel*& new_model);
};
